import pandas as pd
import matplotlib
# Force the use of the 'Agg' backend for headless Docker environments
matplotlib.use('Agg')
...
def plot_performance():
    ...
    if not os.path.exists(input_file):
        print("ERROR: Input file not found at " + input_file)
        return
    ...
    plt.title('Phase 3: Model Performance Audit')
    plt.grid(True)
    ...
    print("SUCCESS: Performance chart saved to " + output_plot)
